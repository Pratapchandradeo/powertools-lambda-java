 ...
 * when the powertools-streaming module is on the classpath.
 */
public final class StreamingUserAgentInterceptor implements ExecutionInterceptor {
    static {
        UserAgentConfigurator.configureUserAgent("streaming");
    }
